...
urlpatterns = [
    ...
    path('panel_admin/', views.vista_admin, name='vista_admin'),
    ...
    # Removed login_operador - now using User-based authentication
    path('logout-operador/', views.logout_operador, name='logout_operador'),
    ...
    path('logout-operador-manual/', views.logout_operador_manual, name='logout-operador-manual'),
    ...
    path('api/licitacion/<int:licitacion_id>/documentos/<int:doc_id>/eliminar/', views.eliminar_documento_licitacion, name='eliminar_documento_licitacion'),    path('api/licitacion/<int:licitacion_id>/observacion/', views.guardar_observacion_operador, name='guardar_observacion_operador'),
