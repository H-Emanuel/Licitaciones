...
update licitaciones_bitacoralicitacion set etapa_id = (select id from licitaciones_etapa where nombre='Adjudicación') where etapa2_fk_id=9;
update licitaciones_bitacoralicitacion set etapa_id = (select id from licitaciones_etapa where nombre='Firma de contrato y orden de compra') where etapa2_fk_id=10;
-- convenio marco
...
update licitaciones_bitacoralicitacion set etapa_id = (select id from licitaciones_etapa where nombre='Adjudicación') where etapa2_fk_id=25;
update licitaciones_bitacoralicitacion set etapa_id = (select id from licitaciones_etapa where nombre='Firma de contrato y orden de compra') where etapa2_fk_id=26;
-- trato directo
...
( 38, 5, (select id from licitaciones_etapa where nombre='Aprobación del concejo municipal'), 4 ),
