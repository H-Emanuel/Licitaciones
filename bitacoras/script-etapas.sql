...
update licitacion_licitacion set etapa_fk_id = (select id from licitaciones_etapa where nombre='Aprobación del concejo') where etapa2_fk_id=9;
...
update licitacion_licitacion set etapa_fk_id = (select id from licitaciones_etapa where nombre='Aprobación del concejo') where etapa2_fk_id=25;
...
update licitaciones_bitacoralicitacion set etapa_id = (select id from licitaciones_etapa where nombre='Aprobación del concejo') where etapa2_id=9;
...
update licitaciones_bitacoralicitacion set etapa_id = (select id from licitaciones_etapa where nombre='Aprobación del concejo') where etapa2_id=25;
...
( 9, 9, (select id from licitaciones_etapa where nombre='Aprobación del concejo'), 1 ),
...
( 21, 9, (select id from licitaciones_etapa where nombre='Aprobación del concejo'), 2 ),
...
( 33, 9, (select id from licitaciones_etapa where nombre='Aprobación del concejo'), 3 ),
...
( 41, 5, (select id from licitaciones_etapa where nombre='Aprobación del concejo'), 4 ),
